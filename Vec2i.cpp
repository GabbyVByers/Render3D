...
Violet::Vec2i& Violet::Vec2i::operator = (const Vec2i& vec) { x = (int)vec.x; y = (int)vec.y; }
Violet::Vec2i& Violet::Vec2i::operator = (const Vec2f& vec) { x = (int)vec.x; y = (int)vec.y; }
Violet::Vec2i& Violet::Vec2i::operator = (const Vec2d& vec) { x = (int)vec.x; y = (int)vec.y; }
